...
(function () {
    window.Bird = Class.extend({
        ...
        render : function () {
            ...
            // 位移画布到小鸟的中点
            // y值的改变,不是改变小鸟的y值,而是改变画布的y值
            game.context.translate(this.x + this.width * 0.5,this.y + this.height * 0.5);
            // 旋转
            game.context.rotate(this.rotateAngle * Math.PI / 180);

            // 绘制小鸟
            game.context.drawImage(game.allImageObj['bird'],this.wing * this.width,0,this.width,this.height,- this.width / 2,- this.height / 2,this.width,this.height);
